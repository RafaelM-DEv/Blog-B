    ...
    <div class="col-lg-6 col-md-8 col-sm-6 col-xs-12 ">
      <div class="q-pa-md q-pt-md">
        <q-form @submit.prevent="onSubmit" @reset="onReset" class="q-gutter-md">
          <!-- Form Title-->
          <q-input class="post-title" filled v-model="post.title"  maxlength="50" counter label="Post Title" hint="What is the title of your post?" lazy-rules :rules="[ val => val && val.length > 0 || 'Please type something']"/>
          <!-- Form Description-->
          <q-input class="post-description" filled v-model="post.description"  maxlength="100" label="Resume" type="textarea" hint="what's the resume? " counter/>
          <!-- Form category-->
